            ...
            <div className="w-full max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8">
                    ...
                    >
                        ...
                        <p className="font-body text-sm text-[#8AAEC0]/70 mt-4 leading-relaxed max-w-[220px]" style={{ wordBreak: 'keep-all' }}>
                    ...
                    >
                        <p className="text-[11px] uppercase tracking-[0.2em] text-[#8AAEC0]/50 font-body mb-5">
                            Shop
                        </p>
                        <ul className="space-y-3">
                            <li>
                                <Link to="/curations" className="font-body text-sm text-[#8AAEC0]/70 hover:text-[#3C7795] transition-colors duration-300">
                                    전체 상품 보기
                                </Link>
                            </li>
                            <li>
                                <Link to="/analysis" className="font-body text-sm text-[#8AAEC0]/70 hover:text-[#3C7795] transition-colors duration-300">
                                    AI 피부 진단
                                </Link>
                            </li>
                            <li>
                                <Link to="/shop" className="font-body text-sm text-[#8AAEC0]/70 hover:text-[#3C7795] transition-colors duration-300">
                                    맞춤 처방
                                </Link>
                            </li>
                        </ul>
                    ...
                    >
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/axiom" className="font-body text-sm text-[#8AAEC0]/70 hover:text-[#3C7795] transition-colors duration-300">
                                    브랜드 스토리
                                </Link>
                            </li>
                            <li>
                ...
                >
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="font-body text-xs text-[#8AAEC0]/40">
                        ...
                        <div className="flex items-center gap-6">
                            <Link to="/privacy" target="_blank" rel="noopener noreferrer" className="font-body text-xs text-[#8AAEC0]/40 hover:text-[#8AAEC0] transition-colors">
                                개인정보처리방침
                            </Link>
                            <a href="#" className="font-body text-xs text-[#8AAEC0]/40 hover:text-[#8AAEC0] transition-colors">
                                이용약관
                            </a>
                        </div>
                    </div>
