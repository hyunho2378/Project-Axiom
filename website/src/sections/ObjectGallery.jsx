...
const OBJECTS = [
  /* ── 시그니처 / 이펙트 ── */
  { file: 'axiom-crystal-v3.html', name: 'crystal',       label: 'CRYSTAL',       ko: '브랜드 크리스탈', desc: '수천 개의 데이터가 하나의 결정으로 피어나는 순간.' },
  { file: 'axiom-dna-helix.html',  name: 'dna-helix',     label: 'DNA HELIX',     ko: 'DNA 헬릭스',     desc: '데이터가 나선으로 정렬되며 분석이 시작되는 순간.' },
  { file: 'axiom-aurora-v2.html',  name: 'aurora-v2',     label: 'AURORA RING',   ko: '오로라 링',      desc: '흐르는 빛의 고리, 살아있는 데이터의 맥동.' },
  { file: 'axiom-nebula.html',     name: 'nebula',        label: 'NEBULA',        ko: '파티클 성운',    desc: '수천 개의 신호가 모여 형태를 찾아가는 과정.' },
  { file: 'axiom-ribbon.html',     name: 'ribbon',        label: 'SILK RIBBON',   ko: '실크 리본',      desc: '피부 위를 흐르는 부드러운 결의 시각화.' },
  { file: 'axiom-stage.html',      name: 'stage',         label: 'PRODUCT STAGE', ko: '제품 스테이지',  desc: '큐레이션된 제품이 놓이는 빛의 무대.' },
  /* ── 제품 오브제 ── */
